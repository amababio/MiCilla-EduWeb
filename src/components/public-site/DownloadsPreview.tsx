            ...
            >
              ...
              {item.fileUrl ? (
                <a
                  ...
                  className="mt-4 inline-flex shrink-0 items-center justify-center rounded-full border border-mauve-300 bg-white px-5 py-2 text-sm font-semibold text-mauve-700 transition hover:bg-mauve-50 sm:mt-0"
                >
                  Download
                </a>
              ) : (
                <span className="mt-4 inline-flex shrink-0 items-center justify-center rounded-full border border-slate-200 bg-white px-5 py-2 text-sm font-semibold text-slate-400 sm:mt-0">
                  Link coming soon
                </span>
              )}
            </article>
